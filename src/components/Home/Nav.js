...
function Nav(props) {
    ...
    return (
        <div className={props.isMobile ? "nav_mobile" : `Nav ${cssFlag}`}>
            ...
            <div id="nav_btn">
                <Link to="/introduce">
                    <p className={location.pathname === "/introduce" ? "bctive" : ""}>소개</p>
                </Link>
                <a>
                    <p
                ...
                <a>
                    <p
                        onClick={(e) => handleClick(e)}
                        className={location.pathname === "/trash" ? "bctive trash" : "trash"}
                    >
                        휴지통
                    </p>
                </a>
                {!location.isLogged ? (
                    <Link to="/login">
                        <p className={location.pathname === "/login" ? "bctive" : ""}>로그인/회원가입</p>
                    </Link>
                ) : (
                    <Link to="/logoutRoute">
                        <p>로그아웃</p>
