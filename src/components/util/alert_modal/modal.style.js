...
export const ModalBtns = styled.button`
    ...
    border: 1.5px solid;
    border-radius: 12px;
    background-color: ${(props) => (props.name === "cancel" ? "#7EB496" : "#F9F8F9")};
    ...
    &:hover {
        border-style: none;
        background-color: ${(props) => (props.name === "cancel" ? "#9FD3B6" : "#EDEDED")};
    }
    &:focus {
        background-color: ${(props) => (props.name === "cancel" ? "#78AA8E" : "#DBDBDB")};
    }
`;
